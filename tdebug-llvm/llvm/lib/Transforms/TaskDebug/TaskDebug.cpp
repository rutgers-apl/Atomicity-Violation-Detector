...
void TaskDebug::intializeTaskDebugFunctions(Module& module) {
  ...
  Constant* td = module.getOrInsertFunction("get_cur_tid", size_ty, NULL);
  Constant* fn = module.getOrInsertFunction("RecordMem", VoidTy, size_ty, void_ptr_ty, int_ty, NULL);
}
